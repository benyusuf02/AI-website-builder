...
namespace YDeveloper.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(YDeveloper.Models.ApplicationUser user)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (Input.ProfilePicture != null)
            {
                ...
                var fileName = $"{user.Id}_{DateTime.Now.Ticks}{Path.GetExtension(Input.ProfilePicture.FileName)}";
